...
// Whisper represents a dark communication interface through the Sagecity
...
// New creates a Whisper client ready to communicate through the Sagecity P2P network.

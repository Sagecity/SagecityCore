...
// Service implements an Sagecity netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Sagecity      // Full Sagecity service if monitoring a full node
	les    *les.LightSagecity // Light Sagecity service if monitoring a light node
...
func New(url string, ethServ *eth.Sagecity, lesServ *les.LightSagecity) (*Service, error) {

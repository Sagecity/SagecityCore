...
// ReleaseOracle is an Sagecity contract to store the current and previous
// versions of the sagecity implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Sagecity user, either

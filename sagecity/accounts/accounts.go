...
// Package accounts implements high level Sagecity account management.
package accounts
...
type Account struct {
	Address common.Address `json:"address"` // Sagecity account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain sagecity.ChainStateReader)

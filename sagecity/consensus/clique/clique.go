...
// ecrecover extracts the Sagecity account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Sagecity address
...
// Sagecity testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Sagecity address of the signing key
...
// Author implements consensus.Engine, returning the Sagecity address recovered

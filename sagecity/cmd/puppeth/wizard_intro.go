...
// setting up a new or managing an existing Sagecity private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Sagecity private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Sagecity network down to  |")
	...
	log.Info("Administering Sagecity network", "name", w.network)

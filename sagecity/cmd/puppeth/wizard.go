...
type wizard struct {
	...
	services map[string][]string   // Sagecity services known to be running on servers
...
// converts it to an Sagecity address. If an empty line is entered, the default
// value is returned.

...
import (
	...
	"github.com/SagecityCore/sagecity/miner"
...
// PublicSagecityAPI provides an API to access Sagecity full node-related
// information.
type PublicSagecityAPI struct {
	e *Sagecity
}

// NewPublicSagecityAPI creates a new Sagecity protocol API for full nodes.
func NewPublicSagecityAPI(e *Sagecity) *PublicSagecityAPI {
	return &PublicSagecityAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicSagecityAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicSagecityAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicSagecityAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *Sagecity) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *Sagecity) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of Sagecity full node-related APIs
...
// admin methods of the Sagecity service.
func NewPrivateAdminAPI(eth *Sagecity) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of Sagecity full node APIs exposed
...
// related public debug methods of the Sagecity service.
func NewPublicDebugAPI(eth *Sagecity) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of Sagecity full node APIs exposed over
...
// private debug methods of the Sagecity service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *Sagecity) *PrivateDebugAPI {

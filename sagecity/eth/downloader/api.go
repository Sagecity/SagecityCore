...
// Syncing provides information when this nodes starts synchronising with the Sagecity network and when it's finished.
...
type SyncingResult struct {
	...
	Status  sagecity.SyncProgress `json:"status"`
}

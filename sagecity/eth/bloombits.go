...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Sagecity
...
func (eth *Sagecity) startBloomHandlers() {
...
// for the Sagecity header bloom filters, permitting blazing fast filtering.

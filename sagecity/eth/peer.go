...
// PeerInfo represents a short summary of the Sagecity sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // Sagecity protocol version negotiated

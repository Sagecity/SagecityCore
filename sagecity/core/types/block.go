...
// Package types contains data types related to Sagecity consensus.
package types
...
// Header represents a block header in the Sagecity blockchain.
type Header struct {
...
// Block represents an entire block in the Sagecity blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Sagecity
...
// EncodeRLP serializes b into the Sagecity RLP block format.
